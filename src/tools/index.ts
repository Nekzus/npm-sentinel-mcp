...
export const greetingTool: Tool = {
    ...
    handler: async (args: { name: string }, _extra: RequestHandlerExtra): Promise<HandlerResponse> => {
        try {
            return {
                content: [
                    {
...
export const cardTool: Tool = {
    ...
    handler: async (_args: Record<string, never>, _extra: RequestHandlerExtra): Promise<HandlerResponse> => {
        try {
...
export const dateTimeTool: Tool = {
    ...
    handler: async (args: { timeZone?: string; locale?: string }, _extra: RequestHandlerExtra): Promise<HandlerResponse> => {
        try {
